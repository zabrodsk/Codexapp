...
VALID_EVENT_TYPES = {
    ...
    "assistant.notification_health_checked",
    "assistant.incident_notified",
    "assistant.incident_retry_attempted",
    "assistant.incident_waiting_for_user",
    "assistant.incident_recovered",
    ...
    "task.capture_failed",
    "meeting.outcome_seen",
    "meeting.outcome_extracted",
    "meeting.outcome_applied",
    "meeting.memory_promoted",
    "meeting.followups_applied",
    "lock.acquired",
    "lock.released",
